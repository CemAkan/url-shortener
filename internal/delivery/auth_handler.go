...
func (h *AuthHandler) Register(c *fiber.Ctx) error {
	...
	verifyLink, err := h.mailService.VerifyLinkGenerator(user.ID, baseURL+"/verify/mail", "email_verification", mailValidationLinkExpireTime)
...
func (h *AuthHandler) ResetPassword(c *fiber.Ctx) error {
	...
	//verify link generator
	verifyLink, err := h.mailService.VerifyLinkGenerator(userID, baseURL+"/verify/password", "password_reset_verification", passwordResetLinkExpireTime)
